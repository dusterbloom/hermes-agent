...
class AIAgent(StreamingMixin, ToolExecutionMixin, FallbackMixin, CompressionMixin, SessionMixin, LoopSupportMixin, ModelSwitchMixin, MessagePrepMixin, NetworkMixin):
    """
